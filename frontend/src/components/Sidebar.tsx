      ...
      >
        ...
        <div className={`${isSidebarOpen ? 'block' : 'hidden lg:hidden'} flex flex-col h-full`}>
          ...
          <div className="px-4 pb-3">
            <button className="flex items-center space-x-3 w-full px-3 py-2 text-sm text-gray-600 hover:bg-gray-50 rounded-md transition-colors">
              <svg className="w-5 h-5 text-gray-600" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden>
